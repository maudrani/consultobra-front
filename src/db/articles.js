...
export const articles = [
...

    {
        ...
        title: '¿Que es el precio por <strong>metro cuadrado</strong>, como hacer un presupuesto por <strong>analogía</strong> y cuando sirve un presupuesto detallado?',
